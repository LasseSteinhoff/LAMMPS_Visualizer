...
public class Master_Program_File : MonoBehaviour
{
    ...
    {
        File.WriteAllText(Path.Combine(Application.dataPath + "/proteincombination/", lammps[current_step].timestep.ToString() + ".json"), JsonUtility.ToJson(analysisResult, prettyPrint: true));
    }
